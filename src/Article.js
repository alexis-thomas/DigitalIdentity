...
,
{
  ...
  return (
    <div className="research">
      ...
      {articles.map((article) => <CardExample2 title={article.title} text={article.description} image={article.image} date={article.date} journal={article.journal} authors={article.authors}
       />)}    </div>
  );
}
